...
import random
token = "your_pushplus_token"  # 请替换为你的 PushPlus token
topic = "your_pushplus_topic"  # 请替换为你的 PushPlus topic
...
if not kjList:
    ...
    send_notice(predicted_content + latest_content, token, topic)
